          ...
          <main className="main-detail-investiment">
            ...
            <div className="content-ivestment">
              <div className="detail-invest">
                <p className="weight-thin">Data da Aplicao: <b className='text-white'> {moment(contract.begin).format('L')}</b></p>
                <p className="weight-thin">Valor Investido: <b className='text-white'>{convertCoinBr(contract.value)}</b></p>
              </div>
