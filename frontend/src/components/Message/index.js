...
export default function Message(props) {
    ...
    return(
        <div>
            <div className={`message ${viewStyle}`} onClick={()=>(setViewDetail(true))}>
                <div>
            ...
            {
            viewDetail &&  <DetailMessage messagem={props.messagem} user_send={props.user_send} viewDetail={(bool)=>onChildChanged(bool)}/>
            }
